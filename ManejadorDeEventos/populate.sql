...
INSERT INTO `Eventos` (ID, Nombre, Descripcion, PrecioBoleta) VALUES (1, 'Marcha por la Patria',
	'Acompáñanos a marchar en pro de los ideales patrios.', 0);

INSERT INTO `Eventos` (ID, Nombre, Descripcion, PrecioBoleta) VALUES (2, 'Festival de Música Electrónica',
	"Disfruta de los mejores DJ's nacionales e internacionales.", 300);

INSERT INTO `Eventos` (ID, Nombre, Descripcion, PrecioBoleta) VALUES (3, 'GamerCon',
